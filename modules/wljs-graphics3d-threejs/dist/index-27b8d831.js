...
Color$1.prototype.name = function () {
    const hex = rgb2hex(this._rgb, 'rgb');
    for (let n of Object.keys(colors)) {
        if (colors[n] === hex) return n.toLowerCase();
    }
    return hex;
};
...
input.format.named = (name) => {
    ...
    if (colors[name]) return hex2rgb(colors[name]);
...
input.autodetect.push({
    p: 5,
    test: (h, ...rest) => {
        if (!rest.length && type(h) === 'string' && colors[h.toLowerCase()]) {
            return 'named';
        }
    }
});
...
const lab$1 = (...args) => new Color$1(...args, 'lab');
Object.assign(chroma$1, { lab: lab$1, getLabWhitePoint, setLabWhitePoint });
...
const lch$1 = (...args) => new Color$1(...args, 'lch');
const hcl = (...args) => new Color$1(...args, 'hcl');

Object.assign(chroma$1, { lch: lch$1, hcl });
...
var interpolate_hsx = (col1, col2, f, m) => {
    ...
    return m === 'oklch'
        ? new Color$1([lbv, sat, hue], m)
        : new Color$1([hue, sat, lbv], m);
};
...
Color$1.prototype.num = function () {
    return rgb2num(this._rgb);
};

const num$1 = (...args) => new Color$1(...args, 'num');
...
const num = (col1, col2, f) => {
    const c1 = col1.num();
    const c2 = col2.num();
    return new Color$1(c1 + f * (c2 - c1), 'num');
};
...
const hcg$1 = (...args) => new Color$1(...args, 'hcg');
chroma$1.hcg = hcg$1;
...
const hsi$1 = (...args) => new Color$1(...args, 'hsi');
chroma$1.hsi = hsi$1;
...
const hsl$1 = (...args) => new Color$1(...args, 'hsl');
chroma$1.hsl = hsl$1;
...
const hsv$1 = (...args) => new Color$1(...args, 'hsv');
chroma$1.hsv = hsv$1;
...
Color$1.prototype.oklab = function () {
    return rgb2oklab(this._rgb);
};

const oklab$1 = (...args) => new Color$1(...args, 'oklab');
...
function scale (colors) {
    ...
    const setColors = function (colors) {
        ...
        if (
            ...
            type(colors) === 'string' &&
            chroma$1.brewer &&
            chroma$1.brewer[colors.toLowerCase()]
        ) {
    ...
    f.classes = function (classes) {
        if (classes != null) {
            if (type(classes) === 'array') {
                ...
                const d = chroma$1.analyze(_positions);
                if (classes === 0) {
...
Color$1.prototype.rgb = function (rnd = true) {
    if (rnd === false) return this._rgb.slice(0, 3);
    return this._rgb.slice(0, 3).map(round$3);
};

Color$1.prototype.rgba = function (rnd = true) {
    return this._rgb.slice(0, 4).map((v, i) => {
        return i < 3 ? (rnd === false ? v : round$3(v)) : v;
    });
};

const rgb = (...args) => new Color$1(...args, 'rgb');
...
const cmyk = (...args) => new Color$1(...args, 'cmyk');
...
const css = (...args) => new Color$1(...args, 'css');
chroma$1.css = css;
...
const gl = (...args) => new Color$1(...args, 'gl');
chroma$1.gl = gl;
...
const hex = (...args) => new Color$1(...args, 'hex');
chroma$1.hex = hex;
...
Color$1.prototype.temp =
    Color$1.prototype.kelvin =
    Color$1.prototype.temperature =
        function () {
            return rgb2temperature(this._rgb);
        };

const temp = (...args) => new Color$1(...args, 'temp');
...
Color$1.prototype.oklch = function () {
    return rgb2oklch(this._rgb);
};

const oklch = (...args) => new Color$1(...args, 'oklch');
...
export { Color$1 as Color, analyze, average, bezier$1 as bezier, blend$1 as blend, brewer, cmyk, colors, contrast, contrastAPCA, css, cubehelix, chroma$1 as default, deltaE, distance, getLabWhitePoint, gl, hcg$1 as hcg, hcl, hex, hsi$1 as hsi, hsl$1 as hsl, hsv$1 as hsv, input, mix as interpolate, temp as kelvin, lab$1 as lab, lch$1 as lch, limits, mix, num$1 as num, oklab$1 as oklab, oklch, random$1 as random, rgb, scale, scales, setLabWhitePoint, temp, temp as temperature, valid };
