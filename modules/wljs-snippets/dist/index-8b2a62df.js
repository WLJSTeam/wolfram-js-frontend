...
var hasRequiredSpline;

function requireSpline () {
	if (hasRequiredSpline) return spline;
	hasRequiredSpline = 1;
...
function requireGradient () {
	...
	var __extends = (gradient && gradient.__extends) || (function () {
	...
	var __spreadArray = (gradient && gradient.__spreadArray) || function (to, from) {
...
var hasRequiredNumericSpline;

function requireNumericSpline () {
	if (hasRequiredNumericSpline) return numericSpline;
	hasRequiredNumericSpline = 1;
	var __extends = (numericSpline && numericSpline.__extends) || (function () {
	    var extendStatics = function (d, b) {
	        extendStatics = Object.setPrototypeOf ||
	            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
	            function (d, b) { for (var p in b) if (Object.prototype.hasOwnProperty.call(b, p)) d[p] = b[p]; };
...
function requireVector () {
	...
	hasRequiredVector = 1;
	var __spreadArray = (vector && vector.__spreadArray) || function (to, from) {
	    for (var i = 0, il = from.length, j = to.length; i < il; i++, j++)
	        to[j] = from[i];
	    return to;
	};
...
function requireComponents () {
	...
	(function (exports) {
		...
		var __exportStar = (components && components.__exportStar) || function(m, exports) {
		    for (var p in m) if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports, p)) __createBinding(exports, m, p);
		};
		Object.defineProperty(exports, "__esModule", { value: true });
		__exportStar(requireCircle(), exports);
		__exportStar(requireColor(), exports);
		__exportStar(requireGradient(), exports);
		__exportStar(requireNumericSpline(), exports);
		__exportStar(requireRect(), exports);
		__exportStar(requireVector(), exports); 
	} (components));
	return components;
}

var hasRequiredRotation;

function requireRotation () {
	if (hasRequiredRotation) return rotation;
	hasRequiredRotation = 1;
	Object.defineProperty(rotation, "__esModule", { value: true });
	rotation.rotationToNormal = void 0;
	var components_1 = requireComponents();
	var math_1 = requireMath();
	/**
...
function requireUtil () {
	...
	(function (exports) {
		...
		__exportStar(requireRotation(), exports);
		__exportStar(requireRules(), exports);
...
function requireDebug () {
	...
	hasRequiredDebug = 1;
	var __spreadArray = (debug && debug.__spreadArray) || function (to, from) {
	    for (var i = 0, il = from.length, j = to.length; i < il; i++, j++)
	        to[j] = from[i];
	    return to;
	};
	...
	debug.Debug = void 0;
	var containers_1 = requireContainers();
	var settings_1 = requireSettings();
	/**
...
var hasRequiredVariation;

function requireVariation () {
	if (hasRequiredVariation) return variation;
	hasRequiredVariation = 1;
...
var hasRequiredEmitterOptions;

function requireEmitterOptions () {
	if (hasRequiredEmitterOptions) return emitterOptions;
	hasRequiredEmitterOptions = 1;
...
var hasRequiredSources;

function requireSources () {
	if (hasRequiredSources) return sources;
	hasRequiredSources = 1;
...
var hasRequiredEmissionOptions;

function requireEmissionOptions () {
	if (hasRequiredEmissionOptions) return emissionOptions;
	hasRequiredEmissionOptions = 1;
	Object.defineProperty(emissionOptions, "__esModule", { value: true });
	emissionOptions.getDefaultEmissionOptions = void 0;
	var components_1 = requireComponents();
	var sources_1 = requireSources();
	/**
...
var hasRequiredRenderOptions;

function requireRenderOptions () {
	if (hasRequiredRenderOptions) return renderOptions;
	hasRequiredRenderOptions = 1;
...
function requireOptions () {
	...
	(function (exports) {
		...
		var __exportStar = (options && options.__exportStar) || function(m, exports) {
		    for (var p in m) if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports, p)) __createBinding(exports, m, p);
		};
		Object.defineProperty(exports, "__esModule", { value: true });
		__exportStar(requireEmitterOptions(), exports);
		__exportStar(requireEmissionOptions(), exports);
		__exportStar(requireRenderOptions(), exports); 
	} (options));
	return options;
}
...
function requireParticle () {
	if (hasRequiredParticle) return particle;
...
function requireEmitter () {
	...
	var vector_1 = requireVector();
	var settings_1 = requireSettings();
	var variation_1 = requireVariation();
	var config_1 = requireConfig();
	var options_1 = requireOptions();
	var particle_1 = requireParticle();
	/**
...
function requireConfetti () {
	...
	var __1 = requireLib();
	var components_1 = requireComponents();
	var modules_1 = requireModules();
	var random = requireRandom();
	var sources = requireSources();
	var variation = requireVariation();
...
function requireTemplates () {
	...
	(function (exports) {
		var __createBinding = (templates && templates.__createBinding) || (Object.create ? (function(o, m, k, k2) {
		    if (k2 === undefined) k2 = k;
		    Object.defineProperty(o, k2, { enumerable: true, get: function() { return m[k]; } });
		}) : (function(o, m, k, k2) {
		    if (k2 === undefined) k2 = k;
		...
		var __exportStar = (templates && templates.__exportStar) || function(m, exports) {
		    for (var p in m) if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports, p)) __createBinding(exports, m, p);
		};
		Object.defineProperty(exports, "__esModule", { value: true });
		__exportStar(requireConfetti(), exports);
		__exportStar(requireSparkles(), exports); 
	} (templates));
	return templates;
}
...
function requireLib () {
	...
	(function (exports) {
		...
		var util_1 = requireUtil();
		__exportStar(requireComponents(), exports);
		__exportStar(requireTemplates(), exports);
		__exportStar(requireShapes(), exports);
		__exportStar(requireModules(), exports);
		...
		exports.variation = requireVariation();
		exports.sources = requireSources();
		exports.random = requireRandom();
		exports.math = requireMath();
		exports.util = requireUtil();
		/**
